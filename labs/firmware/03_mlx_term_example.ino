...
//Code for running the MLX surface temp sensor along with a thermistor
...
//create an object to access functions from MLX library
Adafruit_MLX90614 mlx = Adafruit_MLX90614();

//initiate MLX variables
double objectT = 0;
double ambientT = 0;
